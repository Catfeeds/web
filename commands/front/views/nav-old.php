...
<div class="head_logo">
    <?php
        if(!$userId) {
            ?>
            <div class="logo_div">
                <img src="/cn/images/login_logo.png" alt="logo图标" height="56"/>
...
<!--                        <span>全国咨询热线：</span><span class="logo_orange">400-1816-180</span>-->
                    ...
                    <div class="loginAfter">
                        ...
                        <div class="right-font">
                            <h4><img src="/cn/images/rightList_icon.png" alt="小图标"><?php echo Yii::$app->params['levelName'][$userData['level']]?></h4>
                            <p class="navNickname"><?php echo $userData['nickname']?$userData['nickname']:$userData['userName']?></p>
                        </div>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <span><a href="<?php echo Yii::$app->params['shopUrl']?>/shopping-cart.html">我的购物车</a></span>
                            </li>
                            <li>
                                <div><img src="/cn/images/afterLogin_icon11.png" alt="小图标"/></div>
                                <span><a href="<?php echo Yii::$app->params['shopUrl']?>/order.html">我的订单</a></span>
                            </li>
                            <li>
                                <div> <img src="/cn/images/afterLogin_icon02.png" alt="小图标"/></div>
                                <span><a href="/user/listen.html">听说读写记录</a></span>
                            </li>
<!--                            <li>-->
...
<!--                            </li>-->
                            ...
                            <li>
                                <div><img src="/cn/images/person_iconBG10.png" alt="小图标" width="18"/></div>
                                <span><a href="/user/news.html">消息中心<?php echo $news>0?"<span>$news</span>":''?></a></span>
                            </li>
                            <li>
...
<div class="head_nav">
    <div class="nav_div">
        <ul>
            <li <?php echo $controller=='index'?'class="on"':''?>><a href="/">首页</a></li>
            ...
            <li <?php echo $controller=='read'?'class="on"':''?>><a href="/reading.html">阅读练习 </a></li>
            <li <?php echo $controller=='writing'?'class="on"':''?>><a href="/writing.html">写作练习 </a></li>
            ...
            <li><a href="http://bbs.toeflonline.cn">托福BBS</a></li>
...
<!--            <input type="text"/>-->
            <span>用社交账号直接登录：</span>
            <a href="javascript:;" onclick='toQzoneLogin()'><img src="/cn/images/TFother_login.png" alt="qq登陆"/></a>
        </div>
    </div>
</div>
...
<div class="Dialog login" style="display: none;">
    ...
    <div class="other-login">
        <span>还可以选择QQ登陆</span>
        <a href="#" onclick='toQzoneLogin()'><img src="/cn/images/login_qq.png" alt="qq登陆"/></a>
    </div>
    <script>
...
<div class="reportContent">
    ...
    <div class="inReport">
        <h4>我要举报<span class="reportName">草莓小菇凉</span>的<span class="reportType">评论</span>：</h4>
        <div class="comment">
            <div class="comment-left">
                <img class="reportImage" src="images/" alt="用户头像">
            </div>
            <div class="comment-right">
                <h5><span class="reportName">草莓小菇凉</span>:<span class="reportOldContent">说的非常好，十分有道理，棒棒棒！</span></h5>
...
<div class="shareContent">
    ...
    <div class="inShare">
        <img src="/cn/images/login_logo.png" alt="logo图标" width="80">
        <div class="shareText">
            <div class="shareBook">分享到小申托福</div>
            <div class="shareVal">
                <textarea class="shareContentText" placeholder="我在小申托福做题领取到雷豆啦！"></textarea>
            </div>
            <div class="shareBtn">
                <ul>
                    ...
                    <li data-value="" class="shareStart" onclick="shareSuccess(this)"><input type="button" value="分享"></li>
                </ul>
            </div>
            <div style="clear: both"></div>
        </div>
        ...
        <div class="shareSuccess">
            <p>
                <img src="/cn/images/share_successful.png" alt="分享成功图标"/>分享成功
            </p>
        ...
        <!--雷豆余额不足-->
        <div class="leiDou">
            <img src="/cn/images/share_failure.png" alt="支付雷豆失败图标"/>
            <span>雷豆余额不足</span>
            <a href="#">购买雷豆</a>
