...
<script type="text/javascript" src="/ueditor/ueditor.all.min.js"></script>
        <div class="span10" id="datacontent">
            <ul class="breadcrumb">
                <li class="active">添加鲜花</li>
            </ul>
            <form action="/goods/flower/add" method="post" class="form-horizontal">
                <fieldset>
                                        ...
                                        <li>
                                            ...
                                            <?php
                                                foreach($v['children'] as $val) {
                                                    ?>
                                                    <input type="checkbox" name="data[catId][]" id="" value="<?php echo $val['id']?>"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input type="hidden" class="imageFile" name="data[defaultImage]" value="" placeholder="图片地址">
                        ...
                        <div class="controls">
                            <div style="margin-bottom: 10px" id="InputsWrapper">
                                  <span class="imageList">
                                        <img class="imageStr" width="150px" height="200px" src="" alt=""/>
                                  </span>
                                <br>
                                <br>
                            </div>
                            <input type="hidden" class="imageFileList" name="data[imageStr]" value="" placeholder="图片地址">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea name="data[flowerDes]"></textarea>
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="modulename" class="control-label">包装</label>
                        <div class="controls">
                            <textarea name="data[pack]"></textarea>
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="modulename" class="control-label">已售</label>
                        <div class="controls">
                            <input type="text" id="input1" name="data[sales]">
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="modulename" class="control-label">市场价格</label>
                        <div class="controls">
                            <input type="text" id="input1" name="data[markPrice]">
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="modulename" class="control-label">配送价格</label>
                        <div class="controls">
                            <input type="text" id="input1" name="data[delivery]">
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="input1" name="data[flowerLanguage]">
                        </div>
                    </div>
