...
<div class="span10" id="edit" style="display: none;">
    ...
    <form action="/goods/goods/file-video" method="post" class="form-horizontal" id="form_v" style="display: none">
        <fieldset>
            ...
            <input type="hidden" name="cid" value="<?php echo isset($_GET['id'])?$_GET['id']:'' ?>">
<!--            <div class="hid control-group">-->
