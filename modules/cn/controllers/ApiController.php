...
class ApiController extends ToeflApiControl
{
     ...
     * by Yanni
     */
    public function actionGmatOpenClass(){
        $data = Content::getClass(['fields' => "answer,article,cnName,numbering,sentenceNumber,duration,listeningFile,alternatives,problemComplement",'pageSize'=> 40,'category' => '218,162','page' => 1,'where' => 'c.pid=0']);
        if(!empty($data)){
            $arr['code'] = 1;
            $arr['message'] = '返回数据成功！';
            $arr['data'] = $data;
