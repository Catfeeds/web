...
<head>
    ...
    <style>
        ...
        .RelatedLives-item .RelatedLives-subject:hover{
            color: #175199;
        }
    </style>
</head>
...
<section>
    <div class="w12 location">
        <a href="/">首页</a>&nbsp;>&nbsp;<a href="/topic_square.html">话题</a>&nbsp;>&nbsp;<a href="/topic/<?php echo isset($_GET['topicId'])?$_GET['topicId']:'0' ?>.html"><?php echo $name?></a>&nbsp;>&nbsp;<em><?php echo isset($question['title']) ? $question['title'] : '' ?></em>
            ...
            <div class="Card card_answer_content">
                ...
                <?php foreach ($data as $v) { ?>
                    <div class="list-item">
                        ...
                        <div class="qDetail">
                            <span class="RichText"><?php echo isset($v['cnContent']) ? $v['cnContent'] : '' ?></span>
                        </div>
                    ...
                    <?php
                        foreach($hotQuestion as $v) {
                            ...
                            <div class="questions-item">
                                <a class="aBt" href="/cn/question/<?php echo $topicId?>-<?php echo $v['id']?>.html"><?php echo $v['title']?></a>
                            </div>
                        <?php
                        }
?>
            ...
            <div class="Card">
                ...
                <div class="Card-section">
                    <a class="RelatedLives-item" href="#">
                        <div class="dr_img inb"><img src="/cn/images/81a244cd6_xs.jpg" alt=""></div>
                        <div class="RelatedLives-subject">用批判思维辨别信息，独立思考</div>
                    </a>
                    <a class="RelatedLives-item" href="#">
                        <div class="dr_img inb"><img src="/cn/images/81a244cd6_xs.jpg" alt=""></div>
                        <div class="RelatedLives-subject">融入美国人圈子，你也可以！</div>
                    </a>
                    <a class="RelatedLives-item" href="#">
                        <div class="dr_img inb"><img src="/cn/images/81a244cd6_xs.jpg" alt=""></div>
                        <div class="RelatedLives-subject">用批判思维辨别信息，独立思考</div>
