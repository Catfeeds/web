...
<section>
    <div class="w12 location">
        <a href="/">首页</a>><?php foreach($parent as $v){?><a href="/post/list/<?php echo $v['id']?>.html"><?php echo $v['name']?></a>&nbsp;><?php }?><em><?php echo $data['name'] ?></em>
    </div>
</section>
<!--帖子详情-->
            ...
            <div class="w895 bg-f">
                <div class="issueInfo clearfix">
                    <div class="issuerImg fl"><img
                            src="<?php echo isset($data['image']) ? $data['image'] : '/cn/img/noavatar_big.gif' ?>" alt="">
                    </div>
                    <div style="padding-right: 20px">
                        <div class="clearfix fr issue-R">
                            <div class="clearfix">
                                ...
                                <span
                                    class="inb"> 本帖最后由 <?php echo $data['nickname'] ? $data['nickname'] : $data['username'] ?>
                                            ...
                                            <ul class="downloadList">
                                                ...
                                                foreach ($datum as $k => $v) {
                                                    ...
                                                    <li>
                                                        ...
                                                        <em>(下载次数: <?php echo rand(500,2000)?>)</em>
                                                    </li>
                                                    <!--                                                <li>-->
...
<!--                    <div class="sign">wechat：ybnt110&nbsp;&nbsp;（暗号：留学）</div>-->
                    ...
                    <a class="btn-default" href="#">
                        <i style="font-style: normal">❤&nbsp;</i>收藏 <span
                            id="favoritenumber">1</span>
                    </a>
                    <div class="tr smWrap">
...
<!--        右侧-->
        <div class="fr w285">
            ...
            <ul class="admin">
                <li>
                    <a href="#"><img src="<?php echo isset($v['image']) ? $v['image'] : '/cn/img/noavatar_big.gif' ?>" alt=""></a>
                    <p>admin</p>
                </li>
            </ul>
            <div class="rBanner relative">
                ...
                <ul class="banner">
                    <li><a href="#"><img src="/cn/images/luntan_small04.png" alt=""></a></li>
                    <li><a href="#"><img src="/cn/images/luntan_small04.png" alt=""></a></li>
                    <li><a href="#"><img src="/cn/images/luntan_small04.png" alt=""></a></li>
                </ul>
            </div>
