        ...
        <div class="nfl">
            <div class="f_c">
                    ...
                    <script type="text/javascript">
                        function lock(){
                            ...
                            $.post("/cn/api/lock",{pass:password,catId:<?php echo $data['id']?>},function(re){
                                if(re.code == 1){
                                    location.href="/post/<?php echo $data['id']?>.html"
                                }
                            },'json')
                        }
                    </script>
                <?php
                    ...
                    ?>
                    <h3 class="xs2 mbm">本版块需要成为为社区会员才能进入，你已获得<?php echo $integral?>雷豆，累计获取500雷豆将成为会员</h3>
                    <div class="o">
                            &nbsp;
                            <a href="http://order.gmatonline.cn/pay/order/integral?url=http://gossip.gmatonline.cn/post/<?php echo $data['id']?>.html"><button class="pn pnc vm" type="submit" name="loginsubmit" value="true">
                                <strong>充值</strong>
                            </button></a>
                    </div>
                <?php
