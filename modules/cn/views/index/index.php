...
//                        if ($key < 4) {
                            ...
                            <li>
                                ...
                                <p class="help_live_tit"><a class="ellipsis" target="_blank" href="http://www.smartapply.cn/public-class/<?php echo $v['id'] ?>.html"><?php echo $v['name'] ?></a></p>
                                ...
                                <div class="tm">
                                    ...
                                    <div class="inm tl P_info">
                                        ...
                                        if ($v['duration']) {
                                            ?>
                                            <a class="inm playback_btn" target="_blank" href="http://www.smartapply.cn/public-class/back/<?php echo $v['id'] ?>.html">观看回放</a>
                                            <?php
                                        } else {
                                            ?>
                                            <a class="inm playback_btn" target="_blank" href="http://www.smartapply.cn/public-class/<?php echo $v['id'] ?>.html">详情</a>
                                            <?php
                                        }
                                        ?>
                                    </div>
