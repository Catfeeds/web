        ...
        <div>
            ...
            角色：<select name="role" id="">
                ...
                <?php foreach($role as $r){ ?>
                    <option <?php if((isset($_GET['role'])?$_GET['role']:'')==$r['id']){ ?> selected="selected" <?php } ?> value="<?php echo $r['id'] ?>"><?php echo $r['name'] ?></option>
                    <?php
                } ?>
            </select>
        ...
        <table class="table-container">
            ...
            <?php foreach($data['data'] as $v){ ?>
                <tr>
                    ...
                    <td><a href="/user/user/update?id=<?php echo $v['uid'] ?>">修改角色</a> </td>
                </tr>
                <?php
            }
            ?>
