        ...
        <div class="span10" id="datacontent">
            ...
            <form action="/home/top/update" method="post" class="form-horizontal">
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="input1" value="<?php echo $data['number']?>" name="data[number]">
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        <label for="modulename" class="control-label">鲜花Id</label>
                        <div class="controls">
                            <input type="text" id="input1" value="<?php echo $data['flowerId']?>" name="data[flowerId]">
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="controls">
