...
<div class="span10" id="datacontent">
    ...
    <ul class="nav">
        <li class="dropdown pull-right">
            <a class="dropdown-toggle" href="/home/keywords/add">添加导航</a>
        </li>
    </ul>
        ...
        <table class="table table-hover add_defined">
            ...
            foreach($data as $v) {
                ...
                <tr>
                    ...
                    <td><span> <a href="/home/keywords/update?id=<?php echo $v['id']?>">修改</a> <a href="/home/keywords/delete?id=<?php echo $v['id']?>">删除</a></span></td>
                </tr>
            <?php
            }
            ?>
