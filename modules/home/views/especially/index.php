...
<div class="span10" id="datacontent">
    ...
    <ul class="nav">
        <li class="dropdown pull-right">
            <a class="dropdown-toggle" href="/home/especially/add">添加导航</a>
        </li>
    </ul>
        ...
        <table class="table table-hover add_defined">
            ...
            foreach($especially as $v) {
                ...
                <tr>
                    ...
                    <td><span> <a href="/home/especially/update?id=<?php echo $v['id']?>">修改</a> <a href="/home/especially/delete?id=<?php echo $v['id']?>">删除</a></span></td>
                </tr>
            <?php
            }
            ?>
