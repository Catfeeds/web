...
<div class="span10" id="datacontent">
    ...
    <form action="/home/module/update" method="post" class="form-horizontal">
        <fieldset>
            <div class="control-group">
                <label for="modulename" class="control-label">模块名称</label>
                <div class="controls">
                    <input type="text"  name="data[name]" value="<?php echo $data['name']?>" placeholder="">
                </div>
            </div>
            <?php $left = unserialize($data['left'])?>
            <div class="control-group">
                ...
                <div class="controls">
                    <div style="margin-bottom: 10px" id="InputsWrapper">
                                  <span>
                                      <img class="defaultImage" width="150px" height="200px" src="<?php echo $left['image']?>" alt=""/>
                                  </span>
                        <br>
                        <br>
                    </div>
                    <input type="hidden" class="imageFile" name="data[left][image]" value="<?php echo $left['image']?>" placeholder="图片地址">
                    <a href="javascript:;" class="btn btn-info" onclick="upImage();">上传图片</a>
                    <div>
                        <input type="text"  name="data[left][url]" value="<?php echo $left['url']?>" placeholder="链接地址">
                    </div>
                </div>
            </div>
            ...
            <?php $middle = unserialize($data['middle'])?>
            <div class="control-group">
                <label for="moduledescribe" class="control-label">中间图片</label>
                <div class="controls">
                    <div style="margin-bottom: 10px" id="InputsWrapper">
                                  <span>
                                      <img class="defaultLeftImage" width="150px" height="200px" src="<?php echo $middle['image']?>" alt=""/>
                                  </span>
                        <br>
                        <br>
                    </div>
                    <input type="hidden" class="imageLeftFile" name="data[middle][image]" value="<?php echo $middle['image']?>" placeholder="图片地址">
                    <a href="javascript:;" class="btn btn-info" onclick="upImage1();">上传图片</a>
                    <div>
                        <input type="text"  name="data[middle][url]" value="<?php echo $middle['url']?>" placeholder="链接地址">
                    </div>
                </div>
            </div>
            <script type="text/javascript">
            ...
            <?php $right = unserialize($data['right'])?>
            <div class="control-group">
                ...
                <div class="controls">
                    <div style="margin-bottom: 10px" id="InputsWrapper">
                                  <span>
                                      <img class="defaultRightImage" width="150px" height="200px" src="<?php echo $right['image']?>" alt=""/>
                                  </span>
                        <br>
                        <br>
                    </div>
                    <input type="hidden" class="imageRightFile" name="data[right][image]" value="<?php echo $right['image']?>" placeholder="图片地址">
                    <a href="javascript:;" class="btn btn-info" onclick="upImage2();">上传图片</a>
                    <div>
                        <input type="text"  name="data[right][url]" value="<?php echo $right['url']?>" placeholder="链接地址">
                    </div>
                </div>
            </div>
            <script type="text/javascript">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select name="data[location]">
                        <option <?php echo $data['location'] == 1?'selected="selected"':''?> value="1">上</option>
                        <option <?php echo $data['location'] == 2?'selected="selected"':''?> value="2">下</option>
                        <option <?php echo $data['location'] == 3?'selected="selected"':''?> value="3">中</option>
                    </select>
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    <select name="data[type]">
                        <option <?php echo $data['type'] == 1?'selected="selected"':''?> value="1">特殊</option>
                        <option <?php echo $data['type'] == 2?'selected="selected"':''?> value="2">普通</option>
                    </select>
                </div>
            </div>
            <div class="control-group">
